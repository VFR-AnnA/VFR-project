"""
Script to modify the serve_rest.py file in the Spar3D container to add the /inference endpoint.
This should be run inside the container.
"""

import os

# The original serve_rest.py content
original_content = """
\"\"\"
...
# New content with the /inference endpoint added
new_content = """
\"\"\"
Minimal REST wrapper for SPAR3D.
Start inside the container with:  uvicorn serve_rest:app --host 0.0.0.0 --port 3005
...
with open("modified_serve_rest.py", "w") as f:
    f.write(new_content)

print("Modified serve_rest.py created successfully.")